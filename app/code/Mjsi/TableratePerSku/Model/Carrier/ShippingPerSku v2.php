    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function __construct(
        ...
        \Mjsi\TableratePerSku\Model\ResourceModel\Carrier\TablerateFactory $tablerateFactory
    ) {
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $query_result = $readConnection->fetchAll("SELECT * FROM shipping_tablerate_persku 
                                    ...
                                    OR (dest_country_id = '{$country_id}' AND dest_region_id = '{$region_id}' AND dest_zip = '{$postcode}' AND sku IN ($query_sku))
                                    OR (dest_country_id = '{$country_id}' AND dest_region_id = '{$region_id}' AND dest_zip = '*' AND sku IN ($query_sku))
