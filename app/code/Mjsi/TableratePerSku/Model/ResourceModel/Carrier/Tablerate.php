 ...
 */
namespace Mjsi\TableratePerSku\Model\ResourceModel\Carrier;

use Magento\Framework\Filesystem;
use Mjsi\TableratePerSku\Model\ResourceModel\Carrier\Tablerate\Import;
use Mjsi\TableratePerSku\Model\ResourceModel\Carrier\Tablerate\RateQuery;
use Mjsi\TableratePerSku\Model\ResourceModel\Carrier\Tablerate\RateQueryFactory;
...
class Tablerate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('shipping_tablerate_persku', 'pk');
    }
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
        ...
        if (empty($_FILES['groups']['tmp_name']['tableratepersku']['fields']['import']['value'])) {
            return $this;
            
        }
        $filePath = $_FILES['groups']['tmp_name']['tableratepersku']['fields']['import']['value'];
