...
namespace Mjsi\TableratePerSku\Model\ResourceModel\Carrier\Tablerate\CSV;
...
class RowParser
{
    ...
    public function parse(
        ...
        $sku = $this->getConditionValue($rowData, $rowNumber, $columnResolver);
     ...
     * @throws RowException
     */
    private function getConditionValue(array $rowData, $rowNumber, ColumnResolver $columnResolver)
    {
        // validate condition value
        
        $conditionValue = $columnResolver->getColumnValue(ColumnResolver::SKU, $rowData);
